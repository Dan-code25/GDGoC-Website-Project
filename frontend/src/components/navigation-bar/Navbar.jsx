    ...
    <>
      ...
      <div className="container-fluid px-xl-5">
        ...
        >
          ...
          <button
            className={`${styles.hamburgerBar} d-xl-none`}
            type="button"
          ...
          <div className="d-none d-xl-flex align-items-center gap-5">
            ...
            <a
              href="https://gdg.community.dev/gdg-on-campus-technological-university-of-the-philippines-manila-philippines/"
              target="_blank"
            ...
            <button
              ...
              onClick={() =>
                window.open("https://forms.gle/vfEcZzgwc1ugVaCTA", "_blank")
              }
            >
              JOIN US
            </button>
            ...
            >
              <div
                className={`${styles.profilePicNavbar} ${
                  profilePic ? styles.hasImage : styles.defaultBg
                }`}
                style={
      ...
      <div className={`offcanvas offcanvas-end ${styles.sideBar}`} id="sideBar">
        ...
        <div className="offcanvas-body">
          <div className="d-flex flex-column align-items-center">
            ...
            >
              <div
                className={`${styles.profilePicSideNav} ${
                  profilePic ? styles.hasImage : styles.defaultBg
                }`}
                style={
                  profilePic ? { backgroundImage: `url(${profilePic})` } : {}
      ...
      {showChangePassword && gdgID && (
        <div
          className="OverlayChangePassword"
